    ...
    Modal.prototype.get = function() {
        ...
        if(this.options.iframe) {
            ...
            var $target      = $(utils.escapeSelector(this.href)),
                $ph          = $('<div class="' + utils.getClassname('hide') + '">')
                    .attr('id', 'uxr-modal-placeholder-' + this._instance).insertBefore($target),
                $eventTarget = (this.el !== null) ? this.$el : $(document);

            $eventTarget.one(events.close, function() {
