...
(function(factory) {
    ...
    Modal.prototype.bindUIActions = function() {
        ...
        this.$el.on(events.click, function(e) {
            ...
            if(openedInstances.indexOf(_this._instance) > -1){
                return;
            }
    ...
    Modal.prototype.prepare = function() {
        ...
        openedInstances.push(this._instance);
    ...
    Modal.prototype.close = function() {
        if(this.options.overlayClose && this.isOnlyInstance()) {
            $('#uxr-modal-overlay').hide();
        }

        $('#uxr-modal-instance-' + this._instance).hide();

        openedInstances.splice(openedInstances.indexOf(this._instance), 1);
    ...
    Modal.prototype.isOnlyInstance = function() {
        return openedInstances.length <= 1;
    };
